    ...
    <div className="bg-white text-gray-900 font-sans leading-relaxed">
      ...
      <section className="bg-green-600 text-white py-16 px-4 text-center">
        ...
        <p className="mt-4 text-base max-w-3xl mx-auto">
          💡 <strong>PK Ride ملاکنڈ ڈویژن کی پہلی آن لائن ٹیکسی سروس</strong> ہے۔ ہم اپنی سفری خدمات Swat, Chitral, Kumrat, Upper Dir, Adenzai, Samar Bagh, Timergara اور دیگر علاقوں میں فراہم کر رہے ہیں۔ ہمارا مشن ہے ایک <strong>محفوظ، قابلِ اعتماد، اور سستی</strong> سروس فراہم کرنا۔
        </p>
        <a
      ...
      <section className="py-16 px-4 bg-yellow-100 text-right max-w-5xl mx-auto">
        ...
        <ul className="space-y-4 text-base list-disc pr-6">
          ...
          <li>🧍‍♂️ <strong>ویریفائیڈ رائیڈرز</strong></li>
          <li>🛡️ <strong>محفوظ سفر</strong></li>
        </ul>
      </section>
      ...
      <section className="py-16 px-4 bg-yellow-200 text-right max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10 text-base">
          ...
          <div>👕 کپڑے، فیشن آئٹمز</div>
          <div>📦 کورئیر سروس</div>
          <div>🏨 ہوٹل و بزنس آرڈرز</div>
        </div>
        <div className="bg-white border-r-4 border-green-500 rounded-xl p-6 shadow mb-6">
          <h3 className="text-xl font-semibold text-green-800 mb-3">🍔 کھانے کی سہولت:</h3>
      ...
      <section
        className="relative py-24 px-4 bg-cover bg-center bg-no-repeat text-white text-center"
        style={{ backgroundImage: "url('/images/pkride-middle.jpg')" }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-60"></div>
        <div className="relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 drop-shadow-lg">PK Ride – پاکستان کی اسمارٹ رائیڈ ایپ</h2>
      ...
      {/* Download Section */}
      <section
        className="relative py-20 bg-center bg-no-repeat bg-cover text-white text-center"
